 ...
 * Use the [PharmacistProfileFragment.newInstance] factory method to
...
class PharmacistProfileFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment PharmacistProfileFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            PharmacistProfileFragment().apply {
